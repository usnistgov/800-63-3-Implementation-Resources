...
These types of identity attributes may be presented in different formats and combinations, (e.g., name expressed as first name, last name, middle initial, DOB expressed as DDMMYY, MMYY, YYYYMMDD). Depending on the types of identity evidence that applicants can provide, there are many other types of identity attributes and information that may be collected and considered for identity resolution (e.g., place of employment, voting district, association membership, etc.). In general, self-asserted attributes not supported by identity evidence are not usable for purposes of identity proofing assurance higher than AAL1.
